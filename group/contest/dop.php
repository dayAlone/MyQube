...
?>
	<?
		...
		if (($geiop['CITY_NAME'] == CITY_NAME || $USER->IsAdmin()) && strtotime('30.01.2016') > time()) {?>
			<a href="/group/1/u_contest/" style='margin-top: 5px;display: inline-block;z-index: 1;position:relative;padding: 0 20px;'><img src="/group/u_contest/images/big-banner.jpg" alt="" style="border-radius: 8px;" width='100%'/></a>
		<?}
	?>
