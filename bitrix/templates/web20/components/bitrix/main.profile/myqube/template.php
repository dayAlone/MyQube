...
<?if(!empty($_POST) && $_POST["action_save"] == 1) LocalRedirect("/personal/profile/");
if(empty($arResult["arUser"]["PERSONAL_PHOTO"]) && $_POST["action_save"] == 1){
...
<input type="hidden" name="LOGIN" maxlength="50" value="<? echo $arResult["arUser"]["LOGIN"]?>" />
		...
		<div style="width: 100%;height: 400px; position:relative;">
			<div id="ava_popup"><div id="ava_popup_inner"></div>
				<div class="popup-buttons" style="text-align: center;">
					<input type="submit" class="popup-save" name="save" onclick="send_ava();return false;" value="Сохранить"> 
					<button class="popup-cancel" id="popup-cancel" >Отменить</button>
				</div>
			</div>
		<!-- Левый блок попапа -->
					...
					<div class="popup-edit-popup-left-menu">
						<nav>
							...
							<div class="fileform">
								...
								<input id="upload_avatar" type="file" name="PERSONAL_PHOTO" size="20" onchange="cropperImg(this.value);" />
								<input id="x" type="hidden" id="x" name="x" value="0" />
								<input id="y" type="hidden" id="x" name="x" value="0" />
								<input id="w" type="hidden" id="x" name="x" value="100" />
								<input id="h" type="hidden" id="x" name="x"  value="100"/>
			...
			<div class="profile-edit-popup-right">
				...
				<div class="popup-buttons"><input type="submit" class="popup-save" name="save" value="Сохранить"> <button class="popup-cancel" id="popup-cancel" >Отменить</button></div>
