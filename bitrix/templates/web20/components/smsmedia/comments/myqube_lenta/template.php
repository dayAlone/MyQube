		...
		<form method="post"enctype="multipart/form-data" action="" id="new_comment_form<?=$arParams['OBJECT_ID']?>">
			<fieldset style="border: none;"> 
				...
				<div class="comment_submit_button">
                    <div class="mobile-block comment_submit_button-text" onclick="AjaxFormRequest('new_comment_form<?=$arParams['OBJECT_ID']?>', '<?=$arParams['OBJECT_ID']?>')">ОСТАВИТЬ КОММЕНТАРИЙ</div>
