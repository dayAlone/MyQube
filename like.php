...
{?>
	...
	$(function(){
		$("a.likes" ).click(function(event) 
		{
			...
			$.get(path, {<?=$GLOBALS['gl_like_param']?>: $(this).attr('id'),like: Number($( this ).hasClass( "active" ))<?if(isset($GLOBALS['gl_like_id_1'])){?>,post_id_w: <? echo $GLOBALS['gl_like_id_1'];}?>}, function(data){
			});
